...
public class ResumeProjectPeriodInvalidException extends REPOException {

    public ResumeProjectPeriodInvalidException() {
        super(ErrorCode.RESUME_PROJECT_PERIOD_INVALID);
    }
}
